...
def record_loop(
    ...
    teleop_action_processor: RobotProcessorPipeline[
        RobotAction | tuple[RobotAction, RobotObservation], RobotAction
    ],  # runs after teleop
    ...
    while timestamp < control_time_s:
        ...
        # robot_action_to_send: {'shoulder_pan.pos': -109.99987525598623, 'shoulder_lift.pos': -100.00004285756798, 'elbow_flex.pos': -96.82986737710912, 'wrist_flex.pos': -94.99984017946129, 'wrist_roll.pos': 162.78934171036462, 'gripper.pos': 76.16000000000001}
        # Sending action to robot: {'shoulder_pan.pos': -5.266835292314375, 'shoulder_lift.pos': 32.74052606095891, 'elbow_flex.pos': 35.40576560110329, 'wrist_flex.pos': -75.11352359817215, 'wrist_roll.pos': 162.78934171036462, 'gripper.pos': 76.16000000000001}
        ...
        sleep_time = max(1 / fps - dt_s, 0.0)
        precise_sleep(sleep_time)

        timestamp = time.perf_counter() - start_episode_t
        loop_count += 1

        # Print timing every 30 loops (~1 second at 30 FPS)
        if loop_count % 30 == 0:
